...
#### Modelo de licencias en Android

1. **Android Open Source Project (AOSP)**

**Licencia principal**: Apache 2.0 (permisiva).
- Permite usar, modificar y redistribuir incluso en software **propietario**.
- Incluye una cláusula de patentes que da seguridad a empresas.

Excepciones dentro de **AOSP**:
- El **núcleo** Linux que usa Android está bajo GPLv2 (copyleft fuerte).
- Algunas librerías específicas están bajo LGPL (copyleft débil).

2. **Servicios de Google (GMS – Google Mobile Services)**
- No forman parte de AOSP.
- Incluyen: Google Play, Gmail, YouTube, Google Maps, etc.
- Son **software propietario** bajo **EULA** de Google.
- Solo se pueden usar en dispositivos que pasen la **certificación de Google**.


![](media/modelo_android.png)